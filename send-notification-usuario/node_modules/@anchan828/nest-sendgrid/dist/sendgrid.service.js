...
let SendGridService = class SendGridService {
    constructor(options) {
        ...
        if (options.substitutionWrappers && options.substitutionWrappers.left && options.substitutionWrappers.right) {
            mail_1.setSubstitutionWrappers(options.substitutionWrappers.left, options.substitutionWrappers.right);
            sendgrid_logger_1.logger.log("Set Substitution Wrappers");
        }
    }
    send(data, isMultiple, cb) {
        return __awaiter(this, void 0, void 0, function* () {
            if (Array.isArray(data)) {
                return mail_1.send(data.map((d) => this.mergeWithDefaultMailData(d)), isMultiple, cb);
            }
            else {
                return mail_1.send(this.mergeWithDefaultMailData(data), isMultiple, cb);
            }
        });
    }
    sendMultiple(data, cb) {
        return __awaiter(this, void 0, void 0, function* () {
            return mail_1.sendMultiple(this.mergeWithDefaultMailData(data), cb);
        });
    }
...
SendGridService = __decorate([
    common_1.Injectable(),
    __param(0, common_1.Inject(sendgrid_constants_1.SendGridConstants.SENDGRID_MODULE_OPTIONS)),
